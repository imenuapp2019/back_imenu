                ...
                @foreach($restaurants as $rest)
                    <div class="list-group-item list-group-item-action list-group-item-secondary d-flex flex-row justify-content-between">
                        ...
                        <div class="btn-group ">
                            ...
                            <button type="button" class="btn btn-default bg-danger"  onclick="return confirm('Are you sureto delete {{$rest->name}}?')"><a href="{{ url("restaurantes/delete/$rest->id")}}"><img src="{{asset('images/bin.png')}}" alt="Error"></a></button>
                        </div>
                    </div>
                @endforeach
            </div>
